...
- `o1-scoring-matrix.md` → `startup-scoring-matrix.md`. The methodology is intact and shipped —
...
**CRM field slugs come from the configuration.** `o1_investment_score`, `o1_investor_fit` and
