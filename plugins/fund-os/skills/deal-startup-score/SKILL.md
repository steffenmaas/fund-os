...
CONDITIONAL GO verdicts require GP review before advancing to `deal-flow-triage` or `deal-thesis-screen`. NO-GO verdicts are logged automatically; GP notified by summary digest.
...
```yaml
skill_version: deal-startup-score@0.2.0
