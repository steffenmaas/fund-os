...
- **WF-12** Follow-on Trigger — `portfolio-early-warning-alert, deal-due-diligence, legal-captable-model` — Early Warning catches a follow-on trigger, hands to Investment Memo Draft (follow-on mode), cap-table updated.
